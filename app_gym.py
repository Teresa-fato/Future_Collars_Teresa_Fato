...
app = Flask(__name__, template_folder="templates_gym")
...
def index():
    ...
    try:
        ...
        courses = []
    return render_template("gym_index.html", courses=courses)
...
def booking():
    ...
    return render_template("gym_booking.html", clients=clients, courses=courses)
...
def client():
    ...
    # GET — display form
    return render_template("gym_client.html")
...
def manage():
    ...
    return render_template("gym_manage.html", bookings=bookings)
...
def history(line_from=None, line_to=None):
    ...
    return render_template(
        ...
        line_from=line_from,
        line_to=line_to,
        total=len(all_bookings) if "all_bookings" in dir() else 0,
    )
